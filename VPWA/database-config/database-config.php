...
<html lang="en">
<head>
    <title>VPWA - Database Configuration</title>
    ...
    <!-- used to specify which version of a page to crawl i.e https://example.com 
        not https://www.example.com  or https://example.com/index.php -->
        ...
        <div class="container-fluid"  id="bg-img">
            <div class="dropdown" id="db-settings">
                ...
                <ul class="dropdown-menu">
                    <li><a class="dropdown-item" href="database-config.php">Database settings</a></li>
                    <li><a class="dropdown-item" href="#" id="reset-db">Reset DB</a></li>
                </ul>
            </div>
            <form action="save-config.php" >
            <?php $vpwa = (!empty($_SERVER['HTTPS']) ? 'https' : 'http') . '://' . $_SERVER['HTTP_HOST'] ;?>
                ...
                <div><input type="text" name="dbhost"  placeholder="database host" /></div><br/>
                <div><input type="text" name="dbuser"  placeholder="database user" /></div><br/>
                <div><input type="password" name="dbpass"  placeholder="database password" /></div><br/>
